...
@.str = private unnamed_addr constant [35 x i8] c"Please enter your student number: \00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.2 = private unnamed_addr constant [28 x i8] c"Your C Magic Number is: %d\0A\00", align 1

; Function Attrs: noinline nounwind optnone
define void @conjure_magic() #0 {
entry:
  %studentnumber = alloca i32, align 4
  store i32 0, i32* %studentnumber, align 4
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str, i32 0, i32 0))
  %call1 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i32 0, i32 0), i32* %studentnumber)
  %0 = load i32, i32* %studentnumber, align 4
  %rem = srem i32 %0, 136
  %add = add nsw i32 136, %rem
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.2, i32 0, i32 0), i32 %add)
  ret void
}
